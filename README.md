...
## Development
Currently the emulator is functional with NROM/mapper 0 games (such as Super Mario Bros and Tennis). More mappers will come soon to expand the game library.
